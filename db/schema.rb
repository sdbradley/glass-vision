...
ActiveRecord::Schema[7.0].define(version: 2017_05_14_224057) do
  ...
  create_table "companies_users", id: false, charset: "utf8", force: :cascade do |t|
  ...
  create_table "database_translation_fields", charset: "utf8", force: :cascade do |t|
    t.string "translation_table_name", limit: 50, default: "", null: false
    t.string "translation_field_name", limit: 50, default: "", null: false
  end

  create_table "database_translations", charset: "utf8", force: :cascade do |t|
  ...
  create_table "dimensions", charset: "utf8", force: :cascade do |t|
    t.integer "serie_id", default: 0, null: false
    t.float "value", default: 0.0, null: false
    t.string "type", limit: 6, default: "", null: false
  end

  create_table "door_boring_translations", charset: "utf8", force: :cascade do |t|
  ...
  create_table "door_borings", charset: "utf8", force: :cascade do |t|
    t.string "name"
  ...
  create_table "door_combination_translations", charset: "utf8", force: :cascade do |t|
  ...
  create_table "door_combinations", charset: "utf8", force: :cascade do |t|
    t.string "name"
    t.string "sections"
  ...
  create_table "door_combinations_door_openings", id: false, charset: "utf8", force: :cascade do |t|
    t.integer "door_combination_id"
    t.integer "door_opening_id"
  end

  create_table "door_frame_translations", charset: "utf8", force: :cascade do |t|
    t.integer "door_frame_id"
    t.string "locale", null: false
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "door_frames", charset: "utf8", force: :cascade do |t|
    t.string "name"
    t.integer "sections"
    t.string "preview_image_name"
    t.datetime "created_at"
  ...
  create_table "door_glass_families", charset: "utf8", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  create_table "door_glass_family_translations", charset: "utf8", force: :cascade do |t|
  ...
  create_table "door_glass_translations", charset: "utf8", force: :cascade do |t|
  ...
  create_table "door_glasses", charset: "utf8", force: :cascade do |t|
    t.string "name"
    t.integer "door_glass_family_id"
    t.string "photo_file_name"
    t.string "photo_content_type"
  ...
  create_table "door_glasses_door_panels", id: false, charset: "utf8", force: :cascade do |t|
    t.integer "door_glass_id"
    t.integer "door_panel_id"
  end

  create_table "door_line_options", charset: "utf8", force: :cascade do |t|
  ...
  create_table "door_line_sections", charset: "utf8", force: :cascade do |t|
    t.integer "door_line_id"
  ...
  create_table "door_lines", charset: "utf8", force: :cascade do |t|
  ...
  create_table "door_opening_translations", charset: "utf8", force: :cascade do |t|
    t.integer "door_opening_id"
    t.string "locale", null: false
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "door_openings", charset: "utf8", force: :cascade do |t|
    t.string "name"
    t.string "preview_image_name"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "door_panel_dimensions", charset: "utf8", force: :cascade do |t|
    t.integer "door_panel_id"
    t.float "width"
    t.float "height"
    t.float "price"
  ...
  create_table "door_panel_families", charset: "utf8", force: :cascade do |t|
    t.string "name"
    t.integer "slab_material_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "door_panel_family_translations", charset: "utf8", force: :cascade do |t|
  ...
  create_table "door_panel_translations", charset: "utf8", force: :cascade do |t|
    t.integer "door_panel_id"
    t.string "locale", null: false
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "door_panels", charset: "utf8", force: :cascade do |t|
    t.string "name"
    t.string "preview_image_name"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "door_panels_door_sections", id: false, charset: "utf8", force: :cascade do |t|
    t.integer "door_panel_id"
    t.integer "door_section_id"
  end

  create_table "door_section_translations", charset: "utf8", force: :cascade do |t|
    t.integer "door_section_id"
    t.string "locale", null: false
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "door_sections", charset: "utf8", force: :cascade do |t|
    t.string "name"
    t.string "code"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "frame_profile_translations", charset: "utf8", force: :cascade do |t|
    t.integer "frame_profile_id"
    t.string "locale", null: false
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "frame_profiles", charset: "utf8", force: :cascade do |t|
    t.string "name"
    t.string "photo_file_name"
    t.string "photo_content_type"
    t.integer "photo_file_size"
  ...
  create_table "invoice_numbers", charset: "utf8", force: :cascade do |t|
    t.integer "year"
  ...
  create_table "manual_lines", charset: "utf8", force: :cascade do |t|
    t.text "description"
    t.integer "quantity"
  ...
  create_table "module_type_translations", charset: "utf8", force: :cascade do |t|
  ...
  create_table "module_types", charset: "utf8", force: :cascade do |t|
    t.string "name"
    t.string "gender"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "module_types_users", id: false, charset: "utf8", force: :cascade do |t|
    t.integer "module_type_id"
    t.integer "user_id"
  end

  create_table "opening_translations", charset: "utf8", force: :cascade do |t|
  ...
  create_table "openings", charset: "utf8", force: :cascade do |t|
  ...
  create_table "option_categories", charset: "utf8", force: :cascade do |t|
    t.string "name"
  ...
  create_table "option_categories_options", id: false, charset: "utf8", force: :cascade do |t|
    t.integer "option_category_id"
    t.integer "option_id"
  end

  create_table "option_category_translations", charset: "utf8", force: :cascade do |t|
    t.integer "option_category_id"
    t.string "locale", null: false
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "option_translations", charset: "utf8", force: :cascade do |t|
    t.integer "option_id"
    t.string "locale", null: false
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "options_minimum_unit_translations", charset: "utf8", force: :cascade do |t|
  ...
  create_table "options_minimum_units", charset: "utf8", force: :cascade do |t|
    t.string "description", limit: 50, default: "", null: false
    t.text "comments"
  end

  create_table "options_quotation_lines", charset: "utf8", force: :cascade do |t|
    t.integer "option_id", default: 0, null: false
    t.integer "quotation_line_id", default: 0, null: false
    t.integer "quantity", default: 1, null: false
  end

  create_table "options_quotations", charset: "utf8", force: :cascade do |t|
    t.integer "option_id", default: 0, null: false
  ...
  create_table "preview_images", charset: "utf8", force: :cascade do |t|
    t.integer "opening_id", null: false
    t.string "hinged_on", limit: 1, default: "", null: false
    t.string "image_name"
  end

  create_table "pricing_method_translations", charset: "utf8", force: :cascade do |t|
  ...
  create_table "pricing_methods", charset: "utf8", force: :cascade do |t|
    t.string "description", limit: 50, default: "", null: false
    t.text "comments"
    t.boolean "quantifiable", default: false
  end

  create_table "product_color_translations", charset: "utf8", force: :cascade do |t|
  ...
  create_table "product_colors", charset: "utf8", force: :cascade do |t|
    t.string "name"
    t.string "value"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "quotation_lines", charset: "utf8", force: :cascade do |t|
    t.integer "quotation_id", default: 0, null: false
    t.integer "serie_id", default: 0, null: false
  ...
  create_table "quotation_lines_openings", charset: "utf8", force: :cascade do |t|
    t.integer "quotation_line_id", default: 0, null: false
    t.integer "opening_id", default: 0, null: false
    t.integer "sort_order", default: 0, null: false
  end

  create_table "quotations", charset: "utf8", force: :cascade do |t|
    t.string "description", limit: 50, default: "", null: false
    t.text "comments"
  ...
  create_table "section_dimensions", charset: "utf8", force: :cascade do |t|
    t.integer "quotation_line_id", default: 0, null: false
    t.integer "sort_order", default: 0, null: false
    t.float "value", default: 0.0, null: false
  ...
  create_table "serie_prices", charset: "utf8", force: :cascade do |t|
  ...
  create_table "series", charset: "utf8", force: :cascade do |t|
    t.string "name", limit: 50, default: "", null: false
  ...
  create_table "series_shapes", id: false, charset: "utf8", force: :cascade do |t|
  ...
  create_table "series_translations", charset: "utf8", force: :cascade do |t|
    t.integer "series_id"
    t.string "locale", null: false
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "shapes", charset: "utf8", force: :cascade do |t|
    t.string "name", limit: 50, default: "", null: false
  ...
  create_table "slab_materials", charset: "utf8", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.float "price", default: 0.0
