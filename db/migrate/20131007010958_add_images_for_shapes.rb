...
#    Shape.find_by_name('Fenetre en baie').update_attribute(:photo, File.new(File.join(base_path, ''), 'rb'))
#    Shape.find_by_name('6 Sect. / 2 Sect.').update_attribute(:photo, File.new(File.join(base_path, ''), 'rb'))
#    Shape.find_by_name('5 Sect. / 2 Sect').update_attribute(:photo, File.new(File.join(base_path, 'five-over-two.png'), 'rb'))
#    Shape.find_by_name('1 section sur 2 sections').update_attribute(:photo, File.new(File.join(base_path, ''), 'rb'))
#    Shape.find_by_name('Sect. / Sect. / Sect./ Sect. /Sect.').update_attribute(:photo, File.new(File.join(base_path, ''), 'rb'))
#    Shape.find_by_name('2 sections sur 1 section').update_attribute(:photo, File.new(File.join(base_path, ''), 'rb'))
...
#    Shape.find_by_name('SL+Sec/Sec + SL').update_attribute(:photo, File.new(File.join(base_path, ''), 'rb'))
...
#    Shape.find_by_name('SDL /Sect. / Sect. / Sect.').update_attribute(:photo, File.new(File.join(base_path, ''), 'rb'))
